  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 60 60"
        className="dark:fill-neutral-100 fill-neutral-900"
        width="20"
        height="20"
      >
      ...
      <span
        className={`w-max relative top-0.5 font-libre text-[14px] font-thin tracking-tight dark:text-neutral-100 text-neutral-900 transition-all duration-500 ease-in-out ${

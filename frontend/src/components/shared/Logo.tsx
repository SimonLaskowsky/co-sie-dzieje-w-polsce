...
const Logo = () => {
  ...
  const handleClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
    window.open(
      'https://www.linkedin.com/in/szymon-laskowski-5b866920a/',
      '_blank',
      'noopener,noreferrer'
    );
    window.open(
  ...
  return (
    <a
      ...
      className="flex items-center absolute top-5 left-1/2 -translate-x-1/2 z-10 gap-1 cursor-pointer"
    >
      <svg
        style={{
          transform: isAnimated ? 'translateX(0px)' : 'translateX(27px)',
          transition: 'transform 0.5s ease-in-out',
        }}
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 60 60"
        className="dark:fill-neutral-200 fill-neutral-900"
        width="20"
        height="20"
      >
      ...
      <span
        className={`w-max relative top-0.5 font-libre text-[14px] font-thin tracking-tight dark:text-neutral-200 text-neutral-900 transition-all duration-500 ease-in-out ${

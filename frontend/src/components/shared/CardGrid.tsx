...
const CardGrid = ({ searchQuery }: CardGridProps) => {
  ...
  }, [searchQuery, sortOrder, sortByTitle]);
      ...
      >
        ...
        <div className="flex justify-end absolute right-0 -top-11">
          <button 
            ...
            className={`p-2 cursor-pointer transition-all duration-300 ${isFilterOptionsOpen ? 'text-neutral-500 dark:text-neutral-100' : 'text-neutral-400 dark:text-neutral-500'}`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="18" strokeWidth="1.5" viewBox="0 0 24 24" width="18">
          ...
          <div className="flex gap-2">
            <button 
              ...
              className={`
                ...
                ${isFilterOptionsOpen && 'opacity-100 !pointer-events-auto -translate-y-7 -translate-x-5'}
                ${sortOrder === 'asc' ? 'text-neutral-500 dark:text-neutral-100' : 'text-neutral-400 dark:text-neutral-500'}
              `}
            >
            ...
            <button 
              ...
              className={`
                p-2 absolute top-0 right-0 opacity-0 pointer-events-none transition-all duration-300 cursor-pointer
                ${isFilterOptionsOpen && 'opacity-100 !pointer-events-auto -translate-y-7 translate-x-6'}
                ${sortByTitle !== null ? 'text-neutral-500 dark:text-neutral-100' : 'text-neutral-400 dark:text-neutral-500'}
              `}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24" fill="none">
                <path d="M13 7L3 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                <path d="M10 12H3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>

      ...
      >
        ...
        <div className="flex justify-end absolute right-0 -top-11">
          <button 
            ...
            className={`p-2 cursor-pointer transition-all duration-300 ${isFilterOptionsOpen ? 'text-neutral-100' : 'text-neutral-500'}`}
          >
          ...
          <div className="flex gap-2">
            <button 
              ...
              className={`
                ...
                ${sortOrder === 'asc' ? 'text-neutral-100' : 'text-neutral-500'}
              `}
            >
            ...
            <button 
              ...
              className={`
                ...
                ${sortByTitle !== null ? 'text-neutral-100' : 'text-neutral-500'}
              `}
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="22px" height="22px" viewBox="0 0 24 24" fill="none">

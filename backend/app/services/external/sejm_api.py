...
class SejmAPIClient:
    ...
    def fetch_sejm_voting(
        ...
        Returns:
            Voting data or None
        """
        url = f"https://api.sejm.gov.pl/sejm/term{term}/votings/{sitting}/{voting_number}"
        logger.info(f"Fetching Sejm voting: term={term}, sitting={sitting}, voting={voting_number}")
        return self._fetch_json(url)
